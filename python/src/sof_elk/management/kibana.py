...
class KibanaManager:
    ...
    def __init__(self, es_host: str = "localhost", es_port: int = 9200, kibana_host: str = "localhost", kibana_port: int = 5601) -> None:
    ...
    def _load_template(self, template_type: str, filepath: str) -> None:
        # type: component_template or index_template
...
def run_load_dashboards(args: argparse.Namespace) -> None:
    mgr = KibanaManager(es_host=args.es_host, es_port=args.es_port, kibana_host=args.kibana_host, kibana_port=args.kibana_port)
    mgr.load_all()
