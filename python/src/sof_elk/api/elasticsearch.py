...
class ElasticsearchManagement:
    ...
    """
    def __init__(self, es_client: Optional[Elasticsearch] = None, host: str = "localhost", port: int = 9200) -> None:
        if es_client:
    ...
    def force_merge(self, index: str, only_expunge_deletes: bool = False) -> Any:
        ...
        return self.es.indices.forcemerge(index=index, params=params)
    ...
    def delete_template(self, name: str) -> Any:
        ...
        """
        return self.es.indices.delete_template(name=name, ignore=[400, 404])
