...
class NfdumpManager:
    ...
    @staticmethod
    def process_nfdump(source: str, destination: str, exporter_ip: Optional[str] = None) -> None:
        """
        ...
        # Validate source
        try:
             subprocess.check_call(["nfdump", read_flag, source, "-q", "-c", "1"], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
