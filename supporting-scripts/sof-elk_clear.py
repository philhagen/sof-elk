...
# Optionally, re-load data from disk for the selected index

# future tasks TODO:
# - allow specifcation of a single file or filesystem glob to delete and re-parse
...
parser = argparse.ArgumentParser(description='Clear the SOF-ELK Elasticsearch database and optionally re-parse the input files for the deleted index.')
