...
index_patterns="httpdlog netflow syslog timeline"

kibana_version=$( jq -r '.version' < /opt/kibana/package.json )
kibana_build=$(jq -r '.build.number' < /opt/kibana/package.json )

<<<<<<< HEAD
dashboard_list="httpd introductory netflow syslog syslog-login timeline-l2t"
=======
dashboard_list="httpd introductory netflow syslog timeline"
>>>>>>> be5e9a796f7e7a16142d5eeba87c564a173264e0
